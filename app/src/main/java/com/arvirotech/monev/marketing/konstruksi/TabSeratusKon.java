...
public class TabSeratusKon extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nulView = inflater.inflate(R.layout.fragment_tab_seratus_kon, container, false);
        rvList = (RecyclerView) nulView.findViewById(R.id.rView100Kon);
