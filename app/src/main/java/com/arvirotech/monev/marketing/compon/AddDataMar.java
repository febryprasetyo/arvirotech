...
public class AddDataMar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_data_mar);
        ...
        eKey = findViewById(R.id.tvKey);
        eKey.setVisibility(View.GONE);
    ...
    private void saveData() {
        ...
        String keyLcl = myRef.child("Marketing").child("Perencana").push().getKey();
        hashkon.put("key", keyLcl);
        Task task = myRef.child("Marketing").child("Perencana").child(keyLcl).setValue(hashkon);
        task.addOnSuccessListener(aVoid -> {
            //the data is added and now we are sure to do something related
            Toast.makeText(AddDataMar.this, "Data berhasil disimpan", Toast.LENGTH_SHORT).show();
    ...
    private void back() {
        Intent intent = new Intent(AddDataMar.this, PerencanaMarketing.class);
