...
public class DetailKons extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_kons);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("Detail Pekerjaan Konstruksi");
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.hapus:
                ...
                DatabaseReference mDatabase = database.getReference().child("Marketing").child("Konstruksi").child(key);
                ...
                Intent intent = new Intent(DetailKons.this, PerencanaMarketing.class);
    ...
    private void EditButton() {
        ...
        Intent intent = new Intent(DetailKons.this, EditKon.class);
