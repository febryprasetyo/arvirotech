...
public class AddDataKonMar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_data_kon_mar);
    ...
    private void saveData() {
        ...
        String keyLcl = myRef.child("Marketing").child("Konstruksi").push().getKey();
        hashkon.put("key", keyLcl);
        Task task = myRef.child("Marketing").child("Konstruksi").child(keyLcl).setValue(hashkon);
        task.addOnSuccessListener(aVoid -> {
            //the data is added and now we are sure to do something related
            Toast.makeText(AddDataKonMar.this, "Data berhasil disimpan", Toast.LENGTH_SHORT).show();
    ...
    private void back() {
        Intent intent = new Intent(AddDataKonMar.this, KonstruksiMarketing.class);
