...
public class PrcMarTabAllAdapter extends RecyclerView.Adapter<PrcMarTabAllAdapter.MyViewHolder>{
    ...
    public PrcMarTabAllAdapter(Context context) {
        this.context = context;
    }

    public PrcMarTabAllAdapter(List<listData> dataList) {
