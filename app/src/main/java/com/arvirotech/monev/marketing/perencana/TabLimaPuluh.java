...
public class TabLimaPuluh  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nulView = inflater.inflate(R.layout.tablimapuluh__mar, container, false);

        rvList = (RecyclerView) nulView.findViewById(R.id.rView50);
        rvList.setHasFixedSize(true);
        rvList.setLayoutManager(new LinearLayoutManager(getContext()));
        pagu = (TextView) nulView.findViewById(R.id.tvTotalPagu50);
